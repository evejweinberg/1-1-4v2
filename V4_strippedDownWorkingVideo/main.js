...
function init() {
    ...
    loader.load(objName, mtlName, function(object) {
        ...
        object.rotateOnAxis(new THREE.Vector3(0, 0, 0), 0.0);
...
function AddLights() {
    ...
    directionalLight.position.set(0, 0, 1001);
    directionalLight.castShadow = true;
    directionalLight.shadowDarkness = 1;
    directionalLight.shadowMapSoft = true;
    // scene.add(directionalLight);

    var directionalLightInside = new THREE.DirectionalLight(0xffeedd, 1);

    directionalLightInside.position.set(0, 0, 6001);
